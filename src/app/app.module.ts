...
import { AddConversationPreferences1777000000000 } from 'omniboxd/migrations/1777000000000-add-conversation-preferences';
        ...
        TypeOrmModule.forRootAsync({
          ...
          useFactory: (config: ConfigService) => ({
            ...
            migrations: [
              ...
              AddConversationPreferences1777000000000,
